...
void plot_postfit_combined(std::string filename, double truth_alpha)
{
    ...
    TH1D* hist_mPMT_angular_result = (TH1D*)f->Get("hist_mPMT_angular_result");
    TH1D* hist_mPMT_angular_error_final = (TH1D*)f->Get("hist_mPMT_angular_error_final");
    TH1D* hist_mPMT_angular = new TH1D("","",20,0.5,1);
    int nPar = 1;
    double miny = 1.; double maxy=0;
    for (int i=1;i<=hist_mPMT_angular_result->GetNbinsX();i++)
    {
    ...
    TH1D* hist_BnLPMT_angular = new TH1D("","",20,0.5,1);
    ...
    h_postfit_cor->GetXaxis()->SetBinLabel(2,"L_{#alpha}");
    h_postfit_cor->GetXaxis()->SetBinLabel(3,"A_{BnL}");
    h_postfit_cor->GetXaxis()->SetBinLabel(23,"A_{mPMT}");
    h_postfit_cor->GetXaxis()->SetRangeUser(1,42);
    h_postfit_cor->GetYaxis()->SetBinLabel(2,"L_{#alpha}");
    h_postfit_cor->GetYaxis()->SetBinLabel(3,"A_{BnL}");
    h_postfit_cor->GetYaxis()->SetBinLabel(23,"A_{mPMT}");
...
void plot_postfit_param(){
    ...
    // TCanvas* c1 = new TCanvas();
    // TH1D* h1 = plot_BnLPMT_source("diffusr4_400nm_nominal_BnLPMT_ledprofile_thetas_phis_1percent.root",10648);
    // c1->cd();
    // //h1->Scale(1./h1->GetBinContent(20));
    // h1->Draw();
    // h1->Fit("pol1");
    // c1->SaveAs("test1.pdf");
    //plot_BnLPMT_source("diffusr4_400nm_nominal_BnLPMT_ledprofile_thetas_phis_5percent.root",10648);
    //plot_BnLPMT_source("diffusr4_400nm_nominal_BnLPMT_ledprofile_thetas_phis_10percent.root",10648);

    //plot_mPMT("diffusr4_400nm_nominal_mPMT.root",10648);
    //plot_mPMT("diffusr4_400nm_x2absorption_mPMT.root",11782);
    //plot_mPMT("diffusr4_400nm_x2scattering_mPMT.root",17858);
    //plot_mPMT("diffusr4_350nm_nominal_mPMT.root",6351);
    //plot_mPMT("diffusr4_350nm_x2absorption_mPMT.root",6595);
    //plot_mPMT("diffusr4_350nm_x2scattering_mPMT.root",11828);
    //plot_mPMT("diffusr32_400nm_nominal_mPMT.root",10648);
    //plot_mPMT("diffusr32_400nm_x2absorption_mPMT.root",11782);
    //plot_mPMT("diffusr32_400nm_x2scattering_mPMT.root",17858);
    //plot_mPMT("diffusr32_350nm_nominal_mPMT.root",6351);
    //plot_mPMT("diffusr32_350nm_x2absorption_mPMT.root",6595);
    //plot_mPMT("diffusr32_350nm_x2scattering_mPMT.root",11828);
    // TH1D* h2 = plot_BnLPMT("diffusr4_400nm_nominal_BnLPMT.root",10648);
    // c1->cd();
    // //h2->Scale(1./h2->GetBinContent(20));
    ...
    // h1->Draw();
    // c1->SaveAs("test3.pdf");
    //plot_BnLPMT("diffusr4_350nm_nominal_BnLPMT.root",6351);
    //plot_postfit_combined("diffusr4_400nm_nominal_combined.root",10648);
    //plot_postfit_combined("diffusr4_400nm_x2absorption_combined.root",11782);
    //plot_postfit_combined("diffusr4_400nm_x2scattering_combined.root",17858);
    //plot_postfit_combined("diffusr4_350nm_nominal_combined.root",6351);
    //plot_postfit_combined("diffusr4_350nm_x2absorption_combined.root",6595);
    //plot_postfit_combined("diffusr4_350nm_x2scattering_combined.root",11828);
}